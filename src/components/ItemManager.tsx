        ...
        {items.map(item => (
          <div key={item.id} className="grid grid-cols-12 gap-2">
            <input
              ...
              placeholder="아이템 이름"
              className="col-span-3 px-2 py-1 text-sm rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500"
            />
            <input
              type="number"
              ...
              placeholder="시작 개수"
              className="col-span-2 px-2 py-1 text-sm rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500"
            />
            <input
              type="number"
              value={item.endCount}
            ...
            <button
              ...
              className="col-span-2 px-2 py-1 text-sm text-red-500 hover:text-red-600 transition-colors"
            >
              삭제
            </button>
          </div>
